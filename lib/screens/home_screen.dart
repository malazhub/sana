...
class _HomeScreenState extends State<HomeScreen> {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GridView.count(
                          ...
                          children: [
                            _menuItem("Medications", Icons.medication,
                                Colors.blue, _restoreMedication),
                            _menuItem("Doctors", Icons.person, Colors.green,
                                _restoreDoctor),
                            _menuItem("Pharmacies", Icons.local_pharmacy,
                                Colors.orange, _restorePharmacy),
                            _menuItem("Documents", Icons.folder, Colors.purple,
                                _restoreDocument),
                            _menuItem("Insurance", Icons.credit_card,
                                Colors.indigo, _restoreInsurance),
                            _menuItem("Sharing", Icons.ios_share, Colors.teal,
  ...
  Widget _menuItem(
      String title, IconData icon, Color color, VoidCallback action) {
    return Card(
      elevation: 4,
  ...
  void _restoreMedication() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text("Medications Restored (Photo & Ring Ready)")));
  }

  void _restoreDoctor() async {
    await _client.from('doctors').select();
    ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Doctors & Addresses Restored")));
  }
